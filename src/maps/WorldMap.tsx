...
import { connections, unitIndicatorPositions } from "./WorldMapData";
import { EPlayerColour, IMapProps, ITerritoryColourMap } from "../types";

export const WorldMap = (props: IMapProps) => {
  const [territoryColourMap, setTerritoryColourMap] = useState<
    ITerritoryColourMap
  >({});

  let UnitIndicatorMarkup = null;
  const { playerData, selectionIds = [], showUnitIndicators } = props;
      ...
      return Object.keys(player.territories).map((territoryName) => {
        ...
        return (
          <UnitIndicator
            ...
            // @ts-ignore
            top={unitIndicatorPositions[territoryName][0]}
            // @ts-ignore
            left={unitIndicatorPositions[territoryName][1]}
    ...
    if (playerData) {
      Object.keys(playerData).forEach((playerName) => {
        ...
        Object.keys(player.territories).forEach((territoryName) => {
          map[territoryName] = player.color;
        });
      });
      setTerritoryColourMap(map);
    }
  }, [playerData]);
  ...
  return (
    <div className="world-map">
      {showUnitIndicators && UnitIndicatorMarkup}
      <svg id="WorldMap" width="100%" viewBox="0 0 1024 660">
        <defs>
        ...
        <g id="Africa" visibility="visible">
          <path
            className={`country africa ${
              territoryColourMap["East Africa"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("East Africa")}
            onMouseEnter={() => props.handleMouseEnterTerritory("East Africa")}
            onMouseLeave={() => props.handleMouseExitTerritory("East Africa")}
            id="East Africa"
          ...
          ></path>
          <path
            className={`country africa ${territoryColourMap["Egypt"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Egypt")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Egypt")}
            onMouseLeave={() => props.handleMouseExitTerritory("Egypt")}
            id="Egypt"
          ...
          />
          <path
            className={`country africa ${territoryColourMap["Congo"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Congo")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Congo")}
            onMouseLeave={() => props.handleMouseExitTerritory("Congo")}
            id="Congo"
          ...
          <path
            className={`country africa ${
              territoryColourMap["Madagascar"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Madagascar")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Madagascar")}
            onMouseLeave={() => props.handleMouseExitTerritory("Madagascar")}
            id="Madagascar"
          ...
          <path
            className={`country africa ${
              territoryColourMap["South Africa"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("South Africa")}
            onMouseEnter={() => props.handleMouseEnterTerritory("South Africa")}
            onMouseLeave={() => props.handleMouseExitTerritory("South Africa")}
            id="South Africa"
          ...
          <path
            className={`country africa ${
              territoryColourMap["North Africa"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("North Africa")}
            onMouseEnter={() => props.handleMouseEnterTerritory("North Africa")}
            onMouseLeave={() => props.handleMouseExitTerritory("North Africa")}
            id="North Africa"
        ...
        <g id="Asia" visibility="visible">
          <path
            className={`country asia ${
              territoryColourMap["Afghanistan"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Afghanistan")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Afghanistan")}
            onMouseLeave={() => props.handleMouseExitTerritory("Afghanistan")}
            id="Afghanistan"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["India"] || ""}`}
            onClick={() => props.handleOnClickTerritory("India")}
            onMouseEnter={() => props.handleMouseEnterTerritory("India")}
            onMouseLeave={() => props.handleMouseExitTerritory("India")}
            id="India"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Irkutsk"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Irkutsk")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Irkutsk")}
            onMouseLeave={() => props.handleMouseExitTerritory("Irkutsk")}
            id="Irkutsk"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Kamchatka"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Kamchatka")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Kamchatka")}
            onMouseLeave={() => props.handleMouseExitTerritory("Kamchatka")}
            id="Kamchatka"
          ...
          <path
            className={`country asia ${
              territoryColourMap["Middle East"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Middle East")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Middle East")}
            onMouseLeave={() => props.handleMouseExitTerritory("Middle East")}
            id="Middle East"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Mongolia"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Mongolia")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Mongolia")}
            onMouseLeave={() => props.handleMouseExitTerritory("Mongolia")}
            id="Mongolia"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Siam"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Siam")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Siam")}
            onMouseLeave={() => props.handleMouseExitTerritory("Siam")}
            id="Siam"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["China"] || ""}`}
            onClick={() => props.handleOnClickTerritory("China")}
            onMouseEnter={() => props.handleMouseEnterTerritory("China")}
            onMouseLeave={() => props.handleMouseExitTerritory("China")}
            id="China"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Japan"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Japan")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Japan")}
            onMouseLeave={() => props.handleMouseExitTerritory("Japan")}
            id="Japan"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Siberia"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Siberia")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Siberia")}
            onMouseLeave={() => props.handleMouseExitTerritory("Siberia")}
            id="Siberia"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Ural"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Ural")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Ural")}
            onMouseLeave={() => props.handleMouseExitTerritory("Ural")}
            id="Ural"
          ...
          />
          <path
            className={`country asia ${territoryColourMap["Yakutsk"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Yakutsk")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Yakutsk")}
            onMouseLeave={() => props.handleMouseExitTerritory("Yakutsk")}
            id="Yakutsk"
        ...
        <g id="Oceania " visibility="visible">
          <path
            className={`country oceania ${
              territoryColourMap["Eastern Australia"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Eastern Australia")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Eastern Australia")
            }
            onMouseLeave={() =>
              props.handleMouseExitTerritory("Eastern Australia")
            }
          ...
          <path
            className={`country oceania ${
              territoryColourMap["New Guinea"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("New Guinea")}
            onMouseEnter={() => props.handleMouseEnterTerritory("New Guinea")}
            onMouseLeave={() => props.handleMouseExitTerritory("New Guinea")}
            id="New Guinea"
          ...
          <path
            className={`country oceania ${
              territoryColourMap["Western Australia"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Western Australia")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Western Australia")
            }
            onMouseLeave={() =>
              props.handleMouseExitTerritory("Western Australia")
            }
          ...
          <path
            className={`country oceania ${
              territoryColourMap["Indonesia"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Indonesia")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Indonesia")}
            onMouseLeave={() => props.handleMouseExitTerritory("Indonesia")}
            id="Indonesia"
        ...
        <g id="Europe" visibility="visible">
          <path
            className={`country europe ${
              territoryColourMap["Great Britain"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Great Britain")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Great Britain")
            }
            onMouseLeave={() => props.handleMouseExitTerritory("Great Britain")}
            id="Great Britain"
          ...
          />
          <path
            className={`country europe ${territoryColourMap["Iceland"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Iceland")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Iceland")}
            onMouseLeave={() => props.handleMouseExitTerritory("Iceland")}
            id="Iceland"
          ...
          <path
            className={`country europe ${
              territoryColourMap["Northern Europe"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Northern Europe")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Northern Europe")
            }
            onMouseLeave={() =>
              props.handleMouseExitTerritory("Northern Europe")
            }
            id="Northern Europe"
          ...
          <path
            className={`country europe ${
              territoryColourMap["Scandinavia"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Scandinavia")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Scandinavia")}
            onMouseLeave={() => props.handleMouseExitTerritory("Scandinavia")}
            id="Scandinavia"
          ...
          <path
            className={`country europe ${
              territoryColourMap["Southern Europe"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Southern Europe")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Southern Europe")
            }
            onMouseLeave={() =>
              props.handleMouseExitTerritory("Southern Europe")
            }
            id="Southern Europe"
          ...
          />
          <path
            className={`country europe ${territoryColourMap["Ukraine"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Ukraine")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Ukraine")}
            onMouseLeave={() => props.handleMouseExitTerritory("Ukraine")}
            id="Ukraine"
          ...
          <path
            className={`country europe ${
              territoryColourMap["Western Europe"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Western Europe")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Western Europe")
            }
            onMouseLeave={() =>
              props.handleMouseExitTerritory("Western Europe")
            }
            id="Western Europe"
        ...
        <g id="North America" visibility="visible">
          <path
            className={`country north-america ${
              territoryColourMap["Alaska"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Alaska")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Alaska")}
            onMouseLeave={() => props.handleMouseExitTerritory("Alaska")}
            id="Alaska"
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Alberta"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Alberta")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Alberta")}
            onMouseLeave={() => props.handleMouseExitTerritory("Alberta")}
            id="Alberta"
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Central America"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Central America")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Central America")
            }
            onMouseLeave={() =>
              props.handleMouseExitTerritory("Central America")
            }
            id="Central America"
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Eastern United States"] || ""
            }`}
            onClick={() =>
              props.handleOnClickTerritory("Eastern United States")
            }
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Greenland"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Greenland")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Greenland")}
            onMouseLeave={() => props.handleMouseExitTerritory("Greenland")}
            id="Greenland"
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Northwest Territory"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Northwest Territory")}
            onMouseEnter={() =>
              props.handleMouseEnterTerritory("Northwest Territory")
            }
            onMouseLeave={() =>
              props.handleMouseExitTerritory("Northwest Territory")
            }
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Ontario"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Ontario")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Ontario")}
            onMouseLeave={() => props.handleMouseExitTerritory("Ontario")}
            id="Ontario"
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Western United States"] || ""
            }`}
            onClick={() =>
              props.handleOnClickTerritory("Western United States")
            }
          ...
          <path
            className={`country north-america ${
              territoryColourMap["Quebec"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Quebec")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Quebec")}
            onMouseLeave={() => props.handleMouseExitTerritory("Quebec")}
            id="Quebec"
        ...
        <g id="South America" visibility="visible">
          <path
            className={`country south-america  ${
              territoryColourMap["Argentina"] || ""
            }`}
            onClick={() => props.handleOnClickTerritory("Argentina")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Argentina")}
            onMouseLeave={() => props.handleMouseExitTerritory("Argentina")}
            id="Argentina"
          ...
          <path
            className={`country south-america ${
              selectionIds.includes("Brazil") ? "selected" : ""
            } ${territoryColourMap["Brazil"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Brazil")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Brazil")}
            onMouseLeave={() => props.handleMouseExitTerritory("Brazil")}
            id="Brazil"
          ...
          <path
            className={`country south-america ${
              selectionIds.includes("Peru") ? "selected" : ""
            } ${territoryColourMap["Peru"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Peru")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Peru")}
            onMouseLeave={() => props.handleMouseExitTerritory("Peru")}
            id="Peru"
          ...
          <path
            className={`country south-america ${
              selectionIds.includes("Venezuela") ? "selected" : ""
            } ${territoryColourMap["Venezuela"] || ""}`}
            onClick={() => props.handleOnClickTerritory("Venezuela")}
            onMouseEnter={() => props.handleMouseEnterTerritory("Venezuela")}
            onMouseLeave={() => props.handleMouseExitTerritory("Venezuela")}
            id="Venezuela"
